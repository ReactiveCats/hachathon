...
func (m *TaskMutation) SetTagID(i int) {
	m.tagg = &i
}

// TagID returns the value of the "tag_id" field in the mutation.
func (m *TaskMutation) TagID() (r int, exists bool) {
	v := m.tagg
	if v == nil {
		return
	}
...
// OldTagID returns the old "tag_id" field's value of the Task entity.
// If the Task object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TaskMutation) OldTagID(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *TaskMutation) ClearTagID() {
	m.tagg = nil
	m.clearedFields[task.FieldTagID] = struct{}{}
}

// TagIDCleared returns if the "tag_id" field was cleared in this mutation.
func (m *TaskMutation) TagIDCleared() bool {
	_, ok := m.clearedFields[task.FieldTagID]
	return ok
}

// ResetTagID resets all changes to the "tag_id" field.
func (m *TaskMutation) ResetTagID() {
	m.tagg = nil
	delete(m.clearedFields, task.FieldTagID)
}
...
func (m *TaskMutation) SetTaggID(id int) {
	m.tagg = &id
}

// ClearTagg clears the "tagg" edge to the Tag entity.
func (m *TaskMutation) ClearTagg() {
	m.clearedtagg = true
}

// TaggCleared reports if the "tagg" edge to the Tag entity was cleared.
func (m *TaskMutation) TaggCleared() bool {
	return m.TagIDCleared() || m.clearedtagg
}

// TaggID returns the "tagg" edge ID in the mutation.
func (m *TaskMutation) TaggID() (id int, exists bool) {
	if m.tagg != nil {
		return *m.tagg, true
	}
	return
...
// TaggIDs returns the "tagg" edge IDs in the mutation.
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// TaggID instead. It exists only for internal usage by the builders.
func (m *TaskMutation) TaggIDs() (ids []int) {
	if id := m.tagg; id != nil {
		ids = append(ids, *id)
	}
	return
...
// ResetTagg resets all changes to the "tagg" edge.
func (m *TaskMutation) ResetTagg() {
	m.tagg = nil
	m.clearedtagg = false
}
...
func (m *TaskMutation) Fields() []string {
	...
	if m.tagg != nil {
		fields = append(fields, task.FieldTagID)
	}
	if m.creator != nil {
...
func (m *TaskMutation) ClearedFields() []string {
	...
	if m.FieldCleared(task.FieldTagID) {
		fields = append(fields, task.FieldTagID)
	}
	return fields
}
...
func (m *TaskMutation) AddedEdges() []string {
	...
	if m.tagg != nil {
		edges = append(edges, task.EdgeTagg)
	}
	return edges
}
